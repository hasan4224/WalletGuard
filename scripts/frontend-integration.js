 ...
 * This file demonstrates how to integrate Walletguard with a web frontend
 */

// For React/Vue/Angular applications
export class WalletguardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WalletguardClient(provider, contractAddress);
