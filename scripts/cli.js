...
const contractABI = require("../artifacts/contracts/Walletguard.sol/Walletguard.json").abi;

program
    .name("walletguard-cli")
    .description("CLI tool for Walletguard smart contract")
    .version("1.0.0");
